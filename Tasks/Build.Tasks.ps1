...
[System.IO.FileInfo] $global:Manifest = "$sourcePath\PsDockerMermaid.psd1"
[System.IO.DirectoryInfo] $moduleBuildPath = "$buildPath\PsDockerMermaid"
...
task UpdateDocs {
	...
	New-MarkdownHelp -Module PsDockerMermaid -OutputFolder $docPath
